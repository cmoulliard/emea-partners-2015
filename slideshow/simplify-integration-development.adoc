...
? Add a timeline with solutions / products
...
* Issues about the centric vision of JBI, SCA
...
** Too few components --> will require home code (TODO: To be reviewed)
...
* IT players have proposed proprietary implementation
...
** Due to the fact that the code was generated, 
** Not possible to debug, to test (TODO: To be reviewed)
** Complex to learn, to be used between teams or cross projects (TODO: To be reviewed)
