...
* Use *Common language*, *grammar* between actors (developer, analyst & architect)
* Adopt *Domain* *Specific* *Language* - DSL
* Implement *EIP* Patterns

[#block,left="650px",top="180px"]
image:goal.jpeg[]

[#block,left="50px",top="300px"]
...
|===
a| * Routes {icon-arrow-right} *Endpoints* 
* Registered {icon-arrow-right} CamelContext | image:camel-features.png[]
|===
...
image:microservice.jpeg[]

image:microservice1.png[]

// ************** integration everywhere ************
[#microservice-camel]
== Microservice & Camel

image:microservice-camel.png[]
